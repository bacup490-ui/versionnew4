    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          icon={FolderOpen}
          color="bg-green-500"
          subtitle={`Total projets terminés: ${metrics.totalProjects}`}
        />
        <MetricCard
          ...
          icon={CheckSquare}
          color="bg-red-500"
          subtitle={`Total tâches: ${metrics.totalTasks}`}
        />
        <MetricCard
